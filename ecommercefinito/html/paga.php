        ...
        <div class="card rounded-3">
          <div class="card-body mx-1 my-2">
            <div class="d-flex align-items-center">
              ...
              <div>
                <p class="d-flex flex-column mb-0">
                  <b> <?php echo $_SESSION['Username'] ?></b><span class="small text-muted">**** 8880</span>
                </p>
              </div>
            </div>
              ...
              <div class="d-flex flex-row pb-3">
                <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
                  ...
                  <div class="d-flex flex-column">
                    <p class="mb-1 small text-primary">Totale da pagare</p>
                    <h6 class="mb-0 text-primary">$1899</h6>  <!-- Totale carrello!-->
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex flex-row pb-3">
                <div class="rounded border d-flex w-100 px-3 py-2 align-items-center">
                  ...
                  <div class="d-flex flex-column py-1">
                    <p class="mb-1 small text-primary">Altri Costi</p>
            ...
            <div class="d-flex justify-content-between align-items-center pb-1">
              <a href="carrello.php" class="text-muted">Torna al Carrello</a>
              <a href="index.php"><button type="button" class="btn btn-primary btn-lg">PAGA</button></a>
            </div>
          </div>
        </div>
      </div>
